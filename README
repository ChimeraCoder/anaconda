...
[![Build Status](https://api.travis-ci.org/ChimeraCoder/anaconda.png)](https://travis-ci.org/ChimeraCoder/anaconda) [![GoDoc](https://godoc.org/github.com/ChimeraCoder/anaconda?status.png)](https://godoc.org/github.com/ChimeraCoder/anaconda)
